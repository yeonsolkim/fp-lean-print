...
For the first release, create `v0.1.0` and attach a known-good sample PDF or a
screenshot of the cover, table of contents, chapter opener, and code-heavy page.
That gives new users a quick visual target before they run the layout locally.
